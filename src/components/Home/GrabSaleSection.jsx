  ...
  return (
    <div className={`py-16 ${styles.horizontalPadding}`}>
      <div className="w-full md:h-1/3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
        <div className="h-full flex flex-col gap-y-5 justify-center items-start px-1 md:px-12 bg-pink-50 md:rounded-l-xl">
        ...
        <div className="md:h-1/2 h-full">
          <img src={GrabSaleRight} alt="" className="rounded-r-xl " />
        </div>
      </div>
    </div>
  );
