...
const FilterList = () => {
  return (
    <div className="w-full rounded-xl border mt-4 h-auto max-h-[27rem]">
      <div
        className={`${styles.bgOrange} rounded-t-xl px-6 md:py-10 flex flex-col justify-center items-start gap-4`}
      >
      ...
      <div className="w-full pt-6 ps-6 flex flex-col justify-start items-start gap-3">
